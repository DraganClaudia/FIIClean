document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                ...
                if (userData.success) {
                    ...
                    document.getElementById('user-welcome-message').textContent = 
                        `Salut, ${user.first_name}! Gestionează-ți activitatea cu ușurință.`;
        ...
        function setupRoleContent(role) {
            ...
            const roleConfigs = {
                'admin': {
                    actions: [
                        { href: 'admin.html', icon: '👑', text: 'Admin Panel' },
                        { href: 'orders.html', icon: '📋', text: 'Toate Comenzile' },
                        { href: 'locations.html', icon: '📍', text: 'Gestionare Locații' }
                    ],
                    content: `
                        <div class="card">
                            <h3>🎯 Acces Rapid Admin</h3>
                ...
                'manager': {
                    actions: [
                        { href: 'manager.html', icon: '👨‍💼', text: 'Manager Dashboard' },
                        { href: 'orders.html', icon: '📋', text: 'Comenzi Locația' },
                        { href: 'resources.html', icon: '📦', text: 'Resurse' }
                    ],
                    content: `
                        <div class="card">
                            <h3>🎯 Acces Rapid Manager</h3>
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-top: 1rem;">
                ...
                'client': {
                    actions: [
                        { href: 'client.html', icon: '👤', text: 'Contul Meu' },
                        { onclick: 'quickOrder()', icon: '➕', text: 'Comandă Rapidă' },
                        { href: 'orders.html', icon: '📋', text: 'Comenzile Mele' }
                    ],
                    content: `
                        <div class="card">
                            <h3>🎯 Acces Rapid la Servicii</h3>
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 1rem; margin-top: 1rem;">
                                <button onclick="quickOrder('covoare')" class="btn" style="padding: 2rem; display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
                                    ...
                                    <span>Comandă Spălare Covoare</span>
                                </button>
                                <button onclick="quickOrder('auto')" class="btn" style="padding: 2rem; display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
                                    <span style="font-size: 2rem;">🚗</span>
                                    <span>Comandă Spălare Auto</span>
                                </button>
                                <button onclick="quickOrder('haine')" class="btn" style="padding: 2rem; display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
                                    <span style="font-size: 2rem;">👔</span>
                                    <span>Comandă Curățare Haine</span>
                                </button>
                            </div>
                        </div>
                    `
                ...
                'worker_transport': {
                    actions: [
                        { href: 'transport.html', icon: '🚛', text: 'Transport Dashboard' },
                        { href: 'orders.html', icon: '📋', text: 'Sarcinile Mele' }
                    ],
                    content: `
                        <div class="card">
                            <h3>🚛 Sarcini Transport</h3>
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-top: 1rem;">
                ...
                'worker_cleaner': {
                    actions: [
                        { href: 'cleaner.html', icon: '🧽', text: 'Cleaner Dashboard' },
                        { href: 'orders.html', icon: '📋', text: 'Sarcinile Mele' }
                    ],
                    content: `
                        <div class="card">
                            <h3>🧽 Sarcini Curățare</h3>
                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-top: 1rem;">
            ...
            const html = locations.map(location => `
                <div class="card" style="margin-bottom: 1rem;">
                    ...
                    <p><strong>Status:</strong> ${location.status === 'active' ? 
                        ...
                        '<span class="status-inactive">🔴 Inactiv</span>'}</p>
                </div>
            `).join('');
